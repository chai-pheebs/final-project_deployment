...
<style>
    ...
    .header h1 { font-size: 2.2rem; font-weight: 700; color: #1a1a2e; margin-bottom: 0.3rem; }
    .header p { color: #6b7280; font-size: 1rem; }
    .section-title {
        font-size: 0.75rem; font-weight: 600; color: #9ca3af;
        text-transform: uppercase; letter-spacing: 0.08em; margin: 1.8rem 0 0.8rem 0;
    }
    .result-low {
        background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%);
        border: 2px solid #10b981; border-radius: 16px; padding: 2rem; text-align: center;
    }
    .result-high {
        background: linear-gradient(135deg, #fff1f2 0%, #ffe4e6 100%);
        border: 2px solid #f43f5e; border-radius: 16px; padding: 2rem; text-align: center;
    }
    ...
    .result-prob { font-size: 1rem; color: #374151; margin-bottom: 1.2rem; }
    .result-note { font-size: 0.82rem; color: #6b7280; font-style: italic; }
    .gauge-wrap { margin: 1rem 0 0.5rem 0; }
    .gauge-track { background: #e5e7eb; border-radius: 99px; height: 14px; overflow: hidden; }
    ...
    .gauge-labels { display: flex; justify-content: space-between; font-size: 0.72rem; color: #9ca3af; margin-top: 4px; }
    ...
    div[data-testid="stButton"] button {
        ...
        padding: 0.6rem 2rem; font-size: 1rem; font-weight: 600; width: 100%; margin-top: 1rem;
    }
</style>
...
def train_model():
    ...
    df = pd.concat([df.iloc[:, :5], bp, df.iloc[:, 5:]], axis=1)
...
if st.button("Assess Heart Attack Risk"):
    ...
    if pred == 0:
        ...
        <div class="result-low">
            ...
            <div class="gauge-wrap">
                <div class="gauge-track"><div class="gauge-fill-low" style="width:{pct}%"></div></div>
        ...
        <div class="result-high">
            ...
            <div class="result-prob">Estimated probability of heart attack risk: <strong>{pct}%</strong></div>
            <div class="gauge-wrap">
                <div class="gauge-track"><div class="gauge-fill-high" style="width:{pct}%"></div></div>
                <div class="gauge-labels"><span>0%</span><span>50%</span><span>100%</span></div>
            </div>
    ...
    if sedentary >= 8:       risk_factors.append("🛋️ High Sedentary Hours")
